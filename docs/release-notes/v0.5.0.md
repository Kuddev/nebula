...
- Improved the SSH editor by removing the Agent sign-in choice and using calmer, theme-matched button colors instead of a bright green action button in dark themes.
...
- 改善 SSH 编辑页面，移除 Agent 登录选项，并让保存和取消按钮使用更柔和、更接近当前主题的颜色，避免深色主题下出现突兀的绿色按钮。
